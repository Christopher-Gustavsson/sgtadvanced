...
//using the credentials that we loaded, establish a preliminary conneciton to the database
...
server.get("/api/grades", (req, res)=>{
    ...
    db.connect( ()=>{ 
        ...
        db.query(query, (error, data) =>{
            //if error is null, no error ocurred.
            //create an output object to be sent back to the client
            const output = {
                success: false,
                // data // same as data: data because of es6
            }
